const entries = [
  ...
  {
    name: "Allan Oguis",
    portfolio: "https://github.io/allanoguis/",
...
entries.forEach((entry) => {
  ...
  portfolioCell.innerHTML = entry.portfolio
    ? `<a target="_blank" href="${entry.portfolio}">Portfolio</a>`
    : "N/A";
  githubCell.innerHTML = entry.github
    ? `<a target="_blank" href="${entry.github}">Github</a>`
    : "N/A";
  linkedinCell.innerHTML = entry.linkedin
    ? `<a target="_blank" href="${entry.linkedin}">Linkedin</a>`
    : "N/A";
